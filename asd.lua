    ...
    -- elements 
        ...
        function library:toggle(options)
            ...
            -- instances
                ...
                cfg.items.accent = library:create("Frame", {
                    Parent = inline,
                    BackgroundTransparency = 1;
                    ZIndex = 3;
                    Name = "background",
                ...
                library:apply_theme(cfg.items.accent, "accent", "BackgroundColor3") 

                local UIGradient = library:create("UIGradient", {
                    Parent = cfg.items.accent,
                    Rotation = 90,
                    Color = rgbseq{
                        rgbkey(0, rgb(255, 255, 255)),
                        rgbkey(1, rgb(167, 167, 167))
            ...
            function cfg.set(bool)
                library:tween(cfg.items.accent, {BackgroundTransparency = bool and 0 or 1})
                flags[cfg.flag] = bool
        ...
        function library:keybind(options)
            ...
            -- init 
                ...
                function cfg.set(input, element)
                    ...
                    if not element and self.element and self.element == "toggle" then 
                        self.set(cfg.active)
                    end 
                end

                if self.element and self.element == "toggle" then
                    function self.set(bool)
                        library:tween(self.items.accent, {BackgroundTransparency = bool and 0 or 1})
                        flags[self.flag] = bool
...
-- documentation 
    ...
    task.spawn(function()
        while true do 
            task.wait(1)
            indicator.change_health(math.random(1, 100))
        end 
    end)
    ...
    -- Visuals
        ...
        section:toggle({name = "Indicator", flag = "Indicator", callback = indicator.set_visible})
