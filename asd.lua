		...
		function library:window(properties)
			...
			-- main window
				local main_window = library:panel({
					name = properties and properties.name or "Nightfallen | ", 
			...
			-- theming 
				...
				local watermark = library:watermark({default = os.date('Nightfallen |  - %b %d %Y - %H:%M:%S')})  

				task.spawn(function()
					while task.wait(1) do 
						watermark.change_text(os.date('Nightfallen - Beta - %b %d %Y - %H:%M:%S'))
					end 
				end) 
